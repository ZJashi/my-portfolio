  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        className="text-sm tracking-[0.2em] uppercase text-(--stone)"
      >
      ...
      <motion.h1
        ...
        className="mt-5 text-5xl md:text-6xl font-semibold text-(--ink)"
      >
        Hi, I’m Zura.
      </motion.h1>
      ...
      <motion.p
        ...
        className="mt-6 max-w-2xl text-base md:text-lg text-(--stone) leading-relaxed"
      >
        ...
        <a
          href="/about"
          className="relative font-medium text-(--ink)
            after:absolute after:left-0 after:-bottom-1
            after:h-[1.5px] after:w-0 after:bg-(--ink)
