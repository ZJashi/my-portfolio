...
export default async function NotePage({
  ...
  return (
    <main className="max-w-4xl xl:max-w-[1100px] mx-auto px-6 pt-12 pb-24">
      <div className="xl:grid xl:grid-cols-[1fr_208px] xl:gap-16">
        {/* Left column: content */}
        <div className="min-w-0">
          ...
          <div
            className="
              ...
              [&_pre]:rounded-xl [&_pre]:overflow-hidden [&_pre]:border
              [&_pre]:border-black/8 dark:[&_pre]:border-white/8
              [&_pre]:text-sm [&_pre]:leading-relaxed

              [&_:not(pre)>code]:rounded [&_:not(pre)>code]:px-1.5 [&_:not(pre)>code]:py-0.5
              [&_:not(pre)>code]:text-sm [&_:not(pre)>code]:font-normal
              [&_:not(pre)>code]:before:content-none [&_:not(pre)>code]:after:content-none
              [&_:not(pre)>code]:bg-black/6 dark:[&_:not(pre)>code]:bg-white/8
            "
